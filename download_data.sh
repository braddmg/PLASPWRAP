...
echo "Installing NCBI COGs (COG20) into $DBDIR/COG20"
...
# 5) HOTSPOT database
echo "Downloading HOTSPOT database, models and scripts into $DBDIR/hotspot"
...
git clone https://github.com/Orin-beep/HOTSPOT "$DBDIR/hotspot/HOTSPOT"
